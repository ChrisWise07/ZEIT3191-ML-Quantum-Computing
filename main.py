...
def print_stats_metrics_init_data(
    ...
    print(
        " Pearson Correlation Coefficient for epsilon and x: ",
        np.corrcoef(epsilon_values, x_values)[0][1],
        "\n Pearson Correlation Coefficient for epsilon and y: ",
        np.corrcoef(epsilon_values, y_values)[0][1],
        "\n Pearson Correlation Coefficient for epsilon and z: ",
        np.corrcoef(epsilon_values, z_values)[0][1],
        "\n Pearson Correlation Coefficient for x and y: ",
        np.corrcoef(x_values, y_values)[0][1],
        "\n Pearson Correlation Coefficient for x and z: ",
        np.corrcoef(x_values, z_values)[0][1],
        "\n Pearson Correlation Coefficient for y and z: ",
        np.corrcoef(y_values, z_values)[0][1],
        "\n",
